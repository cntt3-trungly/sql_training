<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Baocao.aspx.cs" Inherits="Baocao" %>
    ...
    <asp:GridView ID="gvbaocao" runat="server" AutoGenerateColumns="False"
            ...
            <asp:TemplateField ItemStyle-Width="120">
                ...
                <asp:TemplateField ItemStyle-Width="120">
                    ...
                    <ItemTemplate>
                    <div class="tablecontent" align="center" style="width: 55px">
                        <asp:Label ID="lblsoCV"  Font-Size=Small  runat="server" Text='<%# Eval("ngaynhan") %>'></asp:Label>
                    </div>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-Width="120">
                    <HeaderTemplate>Tên Cơ Quan</HeaderTemplate>
                    <ItemTemplate>
                    <div class="tablecontent" align="center" style="width: 55px">
                        <asp:Label ID="lblsoCV"  Font-Size=Small  runat="server" Text='<%# Eval("tencq") %>'></asp:Label>
                    </div>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
